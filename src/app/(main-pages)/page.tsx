  ...
  return (
    <>
      ...
      <div className="flex items-end">
        <div>
          <div className="size-16 bg-[#181818] text-white font-medium px-[9px] pb-1 flex items-end relative">
              ...
              <div className="h-[386px] w-[208px] bg-[#181818] p-6 flex flex-col items-center overflow-hidden">
                <div className="flex-1">
                  <div className="relative h-full bg-red-500">
                    <h1 className="text-[140px] absolute -top-[84px] -left-14 text-[#ffffff20] font-medium">
                      23
                    </h1>
                  </div>
                </div>
